...
Route::get('instagram/sliderAjax', [InstagramController::class, 'sliderAjax']);
Route::post('instagram/delete-multiple', [InstagramController::class, 'delete_multiple']);
// });
//  test return view adasd
Route::get('test-1', function () {
    $account = (new InstagramController())->instagramAccounts(27);
});
...
Route::get('/instagram/cleanup-stories', [InstagramController::class, 'cleanupStories'])->name('instagram.cleanup-stories');
