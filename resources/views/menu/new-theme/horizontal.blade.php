        ...
        <div class="card-container">
            <div class="main-grid">
                ...
                <div class="center-section">
                    ...
                    <div class="content-card">
                        <img src="https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=400&h=300&fit=crop" alt="Dessert">
                        <div class="card-overlay">
                            <div style="text-align: center; font-size: 1.2rem;">{{ $rest->home_page_text ?? 'with you, for ever' }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="right-section">
                    <div class="content-card" id="ajax-video-slider-container">
                        ...
                        @else
                            <img src="https://images.unsplash.com/photo-1544787219-7f47ccb76574?w=400&h=600&fit=crop" alt="Cold Coffee Bottle">
                        @endif
