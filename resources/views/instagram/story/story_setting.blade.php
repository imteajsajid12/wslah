...
.story_image.story_inner_setting .carousel-item {
	width: 62% !important;
}
    </style>
    <div class="row">
        ...
        <div class="col-md-3 col-sm-12">
           <div class="story_image story_inner_setting">
    ...
    // $('#carouselExampleIndicators').carousel({ interval: newInterval }).carousel('cycle');
            ...
            // // Reset settings (set default interval and reset to the first slide)
            // carousel.attr('data-interval', value * 1000); // Reset to default interval
            // carousel.carousel({ interval: value * 1000 }); // Reinitialize with default interval
            // carousel.carousel(0); // Reset to the first slide
            // // Restart the carousel
            // carousel.carousel('cycle');

            
            
           // Get the new interval value in seconds (convert it to milliseconds)
var value = Number(value) * 1000; // Example: value = 7 seconds -> 7000 ms
...
// Update the interval dynamically for all slides
carousel.find('.carousel-item').attr('data-bs-interval', value);
